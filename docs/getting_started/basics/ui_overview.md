...
|*Add New Node*|*Edit*|Prompts the "[Create Node](../authoring/#Add-nodes)" dialog.|`Ctrl+A`|
...
|*Add Plug*|*Edit*|If a node is selected, prompts the "[Add Plug](../authoring/#Add-plugs)" dialog.|`Ctrl+P`|
||||
